...
int main()
{
    ...
    for(int id=0; id<N; ++id){
        ...
        for(int rep=0; rep<M; ++rep){
            ...
            string filename = "traffic_matrix__matrix_"+to_string(num_cores-1)+".csv";
            cout<<filename<<endl;
