...
cnkUbA4G2 = 1-mean(connectionUb./connectionTotal, 2);
thpUbA4G2 = 1-mean(throughputUb./throughputTotal, 2);
objUbA4G2 = mean(objUb, 2);
cnkHeA4G2 = 1-mean(connectionHeu./connectionTotal, 2);
thpHeA4G2 = 1-mean(throughputHeu./throughputTotal, 2);
objHeA4G2 = mean(objHeu, 2);
...
save('arch4Guard2beta100.mat', 'cnkUbA4G2', 'thpUbA4G2', 'objUbA4G2', ...
    'cnkHeA4G2', 'thpHeA4G2', 'objHeA4G2')
