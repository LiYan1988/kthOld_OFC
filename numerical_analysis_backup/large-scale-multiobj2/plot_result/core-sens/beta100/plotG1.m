...
h(3) = plot(corev,thpUbA2G1, '--', ...'marker', '^', ...
    'displayname', 'A2 G1 UB Th', 'linewidth', 2, ...
    'color', [.85, .33, .1]);
h(4) = plot(corev,thpHeA2G1, ...'marker', '^', ...
    'displayname', 'A2 G1 Heu Th', 'linewidth', 2, ...
    'color', [.85, .33, .1]);

h(5) = plot(corev, thpUbA2G1, '--', ...'marker', '^', ...
    'displayname', 'A5 G1 UB Th', 'linewidth', 1.5, ...
    'color', [.93, .69, .13]);
...
h(5) = plot(corev, cnkUbA2G1, '--', ...'marker', '^', ...
    'displayname', 'A5 G1 UB Cnk', 'linewidth', 1.5, ...
    'color', [.93, .69, .13]);
