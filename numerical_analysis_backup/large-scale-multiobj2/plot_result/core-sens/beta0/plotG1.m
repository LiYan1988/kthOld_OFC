...
%     'color', [.85, .33, .1]);
% 
% h(5) = plot([1, core2],[thpUbA2G1(1); thpUbA5G1], '--', ...'marker', '^', ...
...
h(1) = plot(corev,cnkUbA2G1, '--', ...'marker', '^', ...
    'displayname', 'A2 G1 UB Cnk', 'linewidth', 2, ...
    'color', [.85, .33, .1]);
h(2) = plot(corev,cnkHeA2G1, ...'marker', '^', ...
...
h(5) = plot([1, core2], [cnkUbA2G1(1); cnkUbA5G1], '--', ...'marker', '^', ...
