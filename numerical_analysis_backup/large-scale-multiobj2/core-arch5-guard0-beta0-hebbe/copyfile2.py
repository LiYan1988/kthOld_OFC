...
for i in range(20):
    ...
    dst = 'pareto2'+str(i)+'.sh'
    dst = os.path.join(dirname, dst)
    
    newline3 = "#SBATCH -J core_arch5_2_"+str(i)+"\n"
    newline7 = "#SBATCH -o core_arch5_2_"+str(i)+".stdout\n"
    newline8 = "#SBATCH -e core_arch5_2_"+str(i)+".stderr\n"
    newline15 = "pdcp pareto2"+str(i)+".py $TMPDIR\n"
    newline19 = "python pareto2"+str(i)+".py\n"
    destination = open( dst, "w" )
    source = open( src, "r" )
    for l, line in enumerate(source):
        if l==3:
