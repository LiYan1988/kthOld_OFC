...
//            for(auto i:energies) cout<<i<<endl;
    ...
    ConnectionList sa_arch5(ConnectionList in_list, bool write_head)
    {
        // simulated annealing process
        s_cur = 0;
        T_cur = Tmax;
...
//            for(auto i:energies) cout<<i<<endl;
    ...
    ConnectionList sa_arch2(ConnectionList in_list, bool write_head)
    {
        // simulated annealing process
        s_cur = 0;
        T_cur = Tmax;
...
//            for(auto i:energies) cout<<i<<endl;
    ...
    void bench_ajmal_arch5(ConnectionList in_list, int msize, int&energy)
    {
        Tensor3d_bool res(num_pods, Matrix_bool(num_cores,
                  Row_bool(num_specs, true)));
        sort(in_list.begin(), in_list.end());
    ...
    void bench_ajmal_arch5_new(ConnectionList in_list, int msize, int&energy)
    {
        Tensor3d_bool res(num_pods, Matrix_bool(num_cores,
                  Row_bool(num_specs, true)));
        sort(in_list.begin(), in_list.end());
