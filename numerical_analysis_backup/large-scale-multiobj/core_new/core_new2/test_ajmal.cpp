...
// void parsimu(Traffic t, Matrix&simu_result)
// {
...
//     simu_result.pushback(num_cnk-ea2b2);
//     t.bench_ajmal_arch4(reverselist, ea4b2);
//     simu_result.pushback(num_cnk-ea4b2);
//     t.bench_ajmal_arch5(order, 0, ea5b2);
//     simu_result.pushback(num_cnk-ea5b2);
//     // cout<<arch2_bench2[id][rep]<<"|"<<arch4_bench2[id][rep]<<"|"<<arch5_bench2[id][rep]<<endl;

//     /*SA*/
//     int ea1s, ea2s, ea4s, ea5s;
//     in_list = t.connection_list;
//     t.bench_ajmal_arch2_new(in_list, ea2s);
//     simu_result.pushback(num_cnk-ea2s);
//     in_list = t.connection_list;
//     t.bench_ajmal_arch4_new(in_list, ea4s);
//     simu_result.pushback(num_cnk-ea4s);
//     in_list = t.connection_list;
//     t.bench_ajmal_arch5_new(in_list, 0, ea5s);
//     simu_result.pushback(num_cnk-ea5s);
...
//     simu_result.pushback(num_cnk-ff2);
//     ff4 = 0;
//     simu_result.pushback(num_cnk-ff4);
//     in_list = t.connection_list;
//     Energy_arch5_is(in_list, num_pods, num_cores, num_specs, ff5);
//     simu_result.pushback(num_cnk-ff5);
...
int main()
{
    ...
    for(int id=0; id<N; ++id){
        ...
        // vector<thread> jobs(M);
        // for(int i=0; i<M){
        //     jobs[i] = thread(parsimu, tvec[i], )
        // }
