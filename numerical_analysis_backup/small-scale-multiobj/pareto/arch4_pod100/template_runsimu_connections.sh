...
#SBATCH -p glenn
#SBATCH -J pareto_arch4_pod100_1
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pareto_arch4_pod100_1.stdout
#SBATCH -e pareto_arch4_pod100_1.stderr
...
pdcp arch1.py arch4_decomposition_new.py $TMPDIR
