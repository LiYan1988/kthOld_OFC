...
#SBATCH -p glenn
#SBATCH -J pareto_arch2_nf_12
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pareto_arch2_nf_12.stdout
#SBATCH -e pareto_arch2_nf_12.stderr
...
pdcp arch1.py arch2_decomposition_new.py $TMPDIR
pdcp traffic_matrix_* $TMPDIR
pdcp pareto12.py $TMPDIR
