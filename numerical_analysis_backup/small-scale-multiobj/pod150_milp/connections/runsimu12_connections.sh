...
#SBATCH -p glenn
#SBATCH -J pod150_12_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_12_connections.stdout
#SBATCH -e pod150_12_connections.stderr
...
pdcp runsimu12_connections.py $TMPDIR

cd $TMPDIR

python runsimu12_connections.py
