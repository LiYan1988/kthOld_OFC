...
#SBATCH -p glenn
#SBATCH -J pod150_0_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_0_connections.stdout
#SBATCH -e pod150_0_connections.stderr
...
pdcp runsimu0_connections.py $TMPDIR

cd $TMPDIR

python runsimu0_connections.py
