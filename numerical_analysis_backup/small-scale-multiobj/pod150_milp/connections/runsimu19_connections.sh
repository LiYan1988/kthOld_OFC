...
#SBATCH -p glenn
#SBATCH -J pod150_19_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_19_connections.stdout
#SBATCH -e pod150_19_connections.stderr
...
pdcp runsimu19_connections.py $TMPDIR

cd $TMPDIR

python runsimu19_connections.py
