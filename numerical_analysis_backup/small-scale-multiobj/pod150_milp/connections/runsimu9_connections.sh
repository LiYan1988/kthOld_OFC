...
#SBATCH -p glenn
#SBATCH -J pod150_9_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_9_connections.stdout
#SBATCH -e pod150_9_connections.stderr
...
pdcp runsimu9_connections.py $TMPDIR

cd $TMPDIR

python runsimu9_connections.py
