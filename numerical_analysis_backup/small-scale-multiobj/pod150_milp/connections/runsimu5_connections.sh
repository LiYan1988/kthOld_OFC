...
#SBATCH -p glenn
#SBATCH -J pod150_5_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_5_connections.stdout
#SBATCH -e pod150_5_connections.stderr
...
pdcp runsimu5_connections.py $TMPDIR

cd $TMPDIR

python runsimu5_connections.py
