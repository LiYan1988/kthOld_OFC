...
#SBATCH -p glenn
#SBATCH -J pod150_8_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_8_connections.stdout
#SBATCH -e pod150_8_connections.stderr
...
pdcp runsimu8_connections.py $TMPDIR

cd $TMPDIR

python runsimu8_connections.py
