...
#SBATCH -p glenn
#SBATCH -J pod150_10_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_10_connections.stdout
#SBATCH -e pod150_10_connections.stderr
...
pdcp runsimu10_connections.py $TMPDIR

cd $TMPDIR

python runsimu10_connections.py
