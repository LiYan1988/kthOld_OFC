...
#SBATCH -p glenn
#SBATCH -J pod150_7_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_7_throughput.stdout
#SBATCH -e pod150_7_throughput.stderr
...
pdcp runsimu7_throughput.py $TMPDIR

cd $TMPDIR

python runsimu7_throughput.py
