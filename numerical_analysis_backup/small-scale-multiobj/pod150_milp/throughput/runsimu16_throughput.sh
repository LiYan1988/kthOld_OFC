...
#SBATCH -p glenn
#SBATCH -J pod150_16_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_16_throughput.stdout
#SBATCH -e pod150_16_throughput.stderr
...
pdcp runsimu16_throughput.py $TMPDIR

cd $TMPDIR

python runsimu16_throughput.py
