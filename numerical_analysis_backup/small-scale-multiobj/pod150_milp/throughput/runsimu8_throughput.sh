...
#SBATCH -p glenn
#SBATCH -J pod150_8_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_8_throughput.stdout
#SBATCH -e pod150_8_throughput.stderr
...
pdcp runsimu8_throughput.py $TMPDIR

cd $TMPDIR

python runsimu8_throughput.py
