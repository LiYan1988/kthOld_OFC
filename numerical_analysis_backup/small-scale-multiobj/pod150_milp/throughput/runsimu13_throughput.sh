...
#SBATCH -p glenn
#SBATCH -J pod150_13_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_13_throughput.stdout
#SBATCH -e pod150_13_throughput.stderr
...
pdcp runsimu13_throughput.py $TMPDIR

cd $TMPDIR

python runsimu13_throughput.py
