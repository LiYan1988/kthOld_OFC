...
#SBATCH -p glenn
#SBATCH -J pod150_3_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_3_throughput.stdout
#SBATCH -e pod150_3_throughput.stderr
...
pdcp runsimu3_throughput.py $TMPDIR

cd $TMPDIR

python runsimu3_throughput.py
