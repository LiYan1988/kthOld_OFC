...
#SBATCH -p glenn
#SBATCH -J pod150_4_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_4_throughput.stdout
#SBATCH -e pod150_4_throughput.stderr
...
pdcp runsimu4_throughput.py $TMPDIR

cd $TMPDIR

python runsimu4_throughput.py
