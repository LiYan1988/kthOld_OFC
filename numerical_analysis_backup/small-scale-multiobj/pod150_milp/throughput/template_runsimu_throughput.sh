...
#SBATCH -p glenn
#SBATCH -J pod150_1_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_1_throughput.stdout
#SBATCH -e pod150_1_throughput.stderr
...
pdcp runsimu1_throughput.py  $TMPDIR

cd $TMPDIR

python runsimu1_throughput.py
