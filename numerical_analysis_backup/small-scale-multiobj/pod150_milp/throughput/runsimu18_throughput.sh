...
#SBATCH -p glenn
#SBATCH -J pod150_18_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod150_18_throughput.stdout
#SBATCH -e pod150_18_throughput.stderr
...
pdcp runsimu18_throughput.py $TMPDIR

cd $TMPDIR

python runsimu18_throughput.py
