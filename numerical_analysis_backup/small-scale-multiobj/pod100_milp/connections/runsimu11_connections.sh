...
#SBATCH -p glenn
#SBATCH -J pod100_11_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_11_connections.stdout
#SBATCH -e pod100_11_connections.stderr
...
pdcp runsimu11_connections.py $TMPDIR

cd $TMPDIR

python runsimu11_connections.py
