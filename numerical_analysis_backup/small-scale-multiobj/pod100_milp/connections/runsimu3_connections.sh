...
#SBATCH -p glenn
#SBATCH -J pod100_3_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_3_connections.stdout
#SBATCH -e pod100_3_connections.stderr
...
pdcp runsimu3_connections.py $TMPDIR

cd $TMPDIR

python runsimu3_connections.py
