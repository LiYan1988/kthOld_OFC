...
#SBATCH -p glenn
#SBATCH -J pod100_2_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_2_connections.stdout
#SBATCH -e pod100_2_connections.stderr
...
pdcp runsimu2_connections.py $TMPDIR

cd $TMPDIR

python runsimu2_connections.py
