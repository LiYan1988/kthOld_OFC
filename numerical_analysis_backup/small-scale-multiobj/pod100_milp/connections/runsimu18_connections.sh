...
#SBATCH -p glenn
#SBATCH -J pod100_18_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_18_connections.stdout
#SBATCH -e pod100_18_connections.stderr
...
pdcp runsimu18_connections.py $TMPDIR

cd $TMPDIR

python runsimu18_connections.py
