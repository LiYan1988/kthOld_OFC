...
#SBATCH -p glenn
#SBATCH -J pod100_17_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_17_connections.stdout
#SBATCH -e pod100_17_connections.stderr
...
pdcp runsimu17_connections.py $TMPDIR

cd $TMPDIR

python runsimu17_connections.py
