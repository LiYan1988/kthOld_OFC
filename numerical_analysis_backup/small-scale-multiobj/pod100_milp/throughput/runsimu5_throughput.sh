...
#SBATCH -p glenn
#SBATCH -J pod100_5_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_5_throughput.stdout
#SBATCH -e pod100_5_throughput.stderr
...
pdcp runsimu5_throughput.py $TMPDIR

cd $TMPDIR

python runsimu5_throughput.py
