...
#SBATCH -p glenn
#SBATCH -J pod100_9_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_9_throughput.stdout
#SBATCH -e pod100_9_throughput.stderr
...
pdcp runsimu9_throughput.py $TMPDIR

cd $TMPDIR

python runsimu9_throughput.py
