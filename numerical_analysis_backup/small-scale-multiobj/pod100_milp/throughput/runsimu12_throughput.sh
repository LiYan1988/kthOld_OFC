...
#SBATCH -p glenn
#SBATCH -J pod100_12_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_12_throughput.stdout
#SBATCH -e pod100_12_throughput.stderr
...
pdcp runsimu12_throughput.py $TMPDIR

cd $TMPDIR

python runsimu12_throughput.py
