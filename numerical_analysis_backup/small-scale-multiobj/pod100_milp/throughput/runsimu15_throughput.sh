...
#SBATCH -p glenn
#SBATCH -J pod100_15_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_15_throughput.stdout
#SBATCH -e pod100_15_throughput.stderr
...
pdcp runsimu15_throughput.py $TMPDIR

cd $TMPDIR

python runsimu15_throughput.py
