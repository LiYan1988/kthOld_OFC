...
#SBATCH -p glenn
#SBATCH -J pod100_17_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_17_throughput.stdout
#SBATCH -e pod100_17_throughput.stderr
...
pdcp runsimu17_throughput.py $TMPDIR

cd $TMPDIR

python runsimu17_throughput.py
