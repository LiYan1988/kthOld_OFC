...
#SBATCH -p glenn
#SBATCH -J pod100_2_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_2_throughput.stdout
#SBATCH -e pod100_2_throughput.stderr
...
pdcp runsimu2_throughput.py $TMPDIR

cd $TMPDIR

python runsimu2_throughput.py
