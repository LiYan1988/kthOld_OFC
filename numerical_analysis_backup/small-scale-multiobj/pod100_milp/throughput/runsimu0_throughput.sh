...
#SBATCH -p glenn
#SBATCH -J pod100_0_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod100_0_throughput.stdout
#SBATCH -e pod100_0_throughput.stderr
...
pdcp runsimu0_throughput.py $TMPDIR

cd $TMPDIR

python runsimu0_throughput.py
