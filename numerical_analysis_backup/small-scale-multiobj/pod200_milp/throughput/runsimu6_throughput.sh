...
#SBATCH -p glenn
#SBATCH -J pod200_6_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod200_6_throughput.stdout
#SBATCH -e pod200_6_throughput.stderr
...
pdcp runsimu6_throughput.py $TMPDIR

cd $TMPDIR

python runsimu6_throughput.py
