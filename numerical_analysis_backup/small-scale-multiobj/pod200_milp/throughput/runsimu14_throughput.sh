...
#SBATCH -p glenn
#SBATCH -J pod200_14_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod200_14_throughput.stdout
#SBATCH -e pod200_14_throughput.stderr
...
pdcp runsimu14_throughput.py $TMPDIR

cd $TMPDIR

python runsimu14_throughput.py
