...
#SBATCH -p glenn
#SBATCH -J pod200_10_throughput
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod200_10_throughput.stdout
#SBATCH -e pod200_10_throughput.stderr
...
pdcp runsimu10_throughput.py $TMPDIR

cd $TMPDIR

python runsimu10_throughput.py
