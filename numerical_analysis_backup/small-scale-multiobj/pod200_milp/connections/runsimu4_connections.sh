...
#SBATCH -p glenn
#SBATCH -J pod200_4_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod200_4_connections.stdout
#SBATCH -e pod200_4_connections.stderr
...
pdcp runsimu4_connections.py $TMPDIR

cd $TMPDIR

python runsimu4_connections.py
