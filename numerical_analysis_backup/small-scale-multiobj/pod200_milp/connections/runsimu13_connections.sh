...
#SBATCH -p glenn
#SBATCH -J pod200_13_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod200_13_connections.stdout
#SBATCH -e pod200_13_connections.stderr
...
pdcp runsimu13_connections.py $TMPDIR

cd $TMPDIR

python runsimu13_connections.py
