...
#SBATCH -p glenn
#SBATCH -J pod200_16_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod200_16_connections.stdout
#SBATCH -e pod200_16_connections.stderr
...
pdcp runsimu16_connections.py $TMPDIR

cd $TMPDIR

python runsimu16_connections.py
