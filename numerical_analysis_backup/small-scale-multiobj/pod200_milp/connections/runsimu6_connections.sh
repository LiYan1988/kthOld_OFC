...
#SBATCH -p glenn
#SBATCH -J pod200_6_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod200_6_connections.stdout
#SBATCH -e pod200_6_connections.stderr
...
pdcp runsimu6_connections.py $TMPDIR

cd $TMPDIR

python runsimu6_connections.py
