...
#SBATCH -p glenn
#SBATCH -J pod200_15_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod200_15_connections.stdout
#SBATCH -e pod200_15_connections.stderr
...
pdcp runsimu15_connections.py $TMPDIR

cd $TMPDIR

python runsimu15_connections.py
