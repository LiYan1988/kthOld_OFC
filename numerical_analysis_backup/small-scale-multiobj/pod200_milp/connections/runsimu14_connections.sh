...
#SBATCH -p glenn
#SBATCH -J pod200_14_connections
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH -o pod200_14_connections.stdout
#SBATCH -e pod200_14_connections.stderr
...
pdcp runsimu14_connections.py $TMPDIR

cd $TMPDIR

python runsimu14_connections.py
