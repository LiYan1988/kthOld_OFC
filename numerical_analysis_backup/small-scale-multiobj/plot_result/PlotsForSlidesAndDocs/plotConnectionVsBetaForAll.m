...
h(1) = semilogx(paretoArch2Old(:,5)*200, paretoArch2Old(:,3), 'linewidth', 2, ...
...
h(3) = semilogx(x, y4, 'linewidth', 2, ...
    'displayname', 'A3', 'color', [0, 0.45, 0.74]);

box(axes2, 'on')
grid(axes2, 'on')
xlabel('\beta', 'fontsize', 16)
ylabel('Connection', 'fontsize', 16)
h = legend(h(1:3), 'location', 'northeast');
h.FontSize = 18;
...
plot(0.4,paretoArch2Old(11, 3),'marker', 'o', ...
'linewidth', 3, 'markersize', 8, 'color', [0.47, 0.67, 0.19])

plot(0.2,paretoArch4Old(10, 3),'marker', 'o', ...
'linewidth', 3, 'markersize', 8, 'color', [0.47, 0.67, 0.19])

plot(0.8,paretoArch5Old2(12, 3),'marker', 'o', ...
'linewidth', 3, 'markersize', 8, 'color', [0.47, 0.67, 0.19])

saveas(figure2, 'ConnectionVsBetaAll.png')