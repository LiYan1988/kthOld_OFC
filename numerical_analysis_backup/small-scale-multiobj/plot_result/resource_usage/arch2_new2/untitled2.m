...
fileName = 'tensor_milp_3.000000e-02.csv';
...
fileName = 'tensor_milp_1.000000e+00.csv';
...
fileName = 'tensor_heuristic_3.000000e-02.csv';
...
fileName = 'tensor_heuristic_1.000000e+00.csv';
...
set(axes2, 'xticklabel', [0, 0.04, 0.2]);
xlabel('\beta', 'fontsize', 12)
...
%% Save data
uepcArch2New = ueCoreAve;
rupcArch2New = rupcAve;
save('Arch2New.mat', 'uepcArch2New', 'rupcArch2New')