...
% alpha=1, beta=0, MILP
fileName = 'tensor_milp_0.00e+00.csv';
...
fileName = 'tensor_milp_4.00e-02.csv';
...
fileName = 'tensor_milp_1.00e+00.csv';
...
fileName = 'tensor_heuristic_0.00e+00.csv';
...
fileName = 'tensor_heuristic_4.00e-02.csv';
...
fileName = 'tensor_heuristic_1.00e+00.csv';
...
h.FontSize = 12;
saveas(figure1, 'resourceUtilizationPerCoreAveArch4Old.jpg')
...
set(bar1(1), 'displayname', 'Heuristic')
set(bar1(2), 'displayname', 'MILP')
h = legend(axes1, 'show', 'location', 'northeast');
h.FontSize = 12;
saveas(figure1, 'utilizationEntropyPerCoreAveArch4Old.jpg')

%% calculate resource efficiency
% efficiencyMILP = [0.531945169713, 0.81737067289, 0.820395348837]';
% efficiencyHeuristic = [0.606379343817, 0.794402654867, 0.792294900222]';
% efficiency = [efficiencyHeuristic, efficiencyMILP];