...
h.FontSize = 12;
saveas(figure1, 'RUPCArch4New.jpg')
...
h.FontSize = 12;
saveas(figure2, 'UEPCArch4New.jpg')

%% Save data
uepcArch4New = uePerPod;
rupcArch4New = rupcPerCore;
save('Arch4New.mat', 'uepcArch4New', 'rupcArch4New')