...
% text(pod100CoAvg(1, 1)+10, pod100CoAvg(2, 1)*0.01, 'Co MILP LB')
% plot(pod100CoAvg(1, 2), pod100CoAvg(2, 2)*0.01, 'd', 'displayname', 'Arch2 Co MILP UB', 'linewidth', 2)
% text(pod100CoAvg(1, 2)+10, pod100CoAvg(2, 2)*0.01, 'Co MILP UB')
x = (pod100CoAvg(1, 2)+0*pod100CoAvg(1, 1));
y = (pod100CoAvg(2, 2)*0.01+0*pod100CoAvg(2, 1)*0.01);
...
% text(pod100ThAvg(1, 1)+10, pod100ThAvg(2, 1)*0.01, 'Th MILP LB')
% plot(pod100ThAvg(1, 2), pod100ThAvg(2, 2)*0.01, '^', 'displayname', 'Arch2 Th MILP UB', 'linewidth', 2)
% text(pod100ThAvg(1, 2)+10, pod100ThAvg(2, 2)*0.01, 'Th MILP UB')
x = (0*pod100ThAvg(1, 1)+1*pod100ThAvg(1, 2));
y = (0*pod100ThAvg(2, 1)*0.01+1*pod100ThAvg(2, 2)*0.01);
...
% text(pod100HyAvg(1, 1)+10, pod100HyAvg(2, 1)*0.01, 'Hy MILP LB')
% plot(pod100HyAvg(1, 2), pod100HyAvg(2, 2)*0.01, '^', 'displayname', 'Arch2 Hy MILP UB', 'linewidth', 2)
% text(pod100HyAvg(1, 2)+10, pod100HyAvg(2, 2)*0.01, 'Hy MILP UB')
