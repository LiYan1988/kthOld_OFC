...
text(pod100BmAvg(1, 1)+10, pod100BmAvg(2, 1)*0.01, 'Arch2 FF FWD')
plot(pod100BmAvg(1, 2), pod100BmAvg(2, 2)*0.01, '*', 'displayname', 'Arch2 FF BWD', 'linewidth', 2)
text(pod100BmAvg(1, 2)+10, pod100BmAvg(2, 2)*0.01, 'Arch2 FF BWD')
plot(pod100BmAvg(1, 4), pod100BmAvg(2, 4)*0.01, '+', 'displayname', 'Arch2 AJ BWD', 'linewidth', 2)
text(pod100BmAvg(1, 4)+10, pod100BmAvg(2, 4)*0.01, 'Arch2 AJ BWD')

plot(pod100CoAvg(1, 1), pod100CoAvg(2, 1)*0.01, 's', 'displayname', 'Arch2 Co MILP LB', 'linewidth', 2)
text(pod100CoAvg(1, 1)+10, pod100CoAvg(2, 1)*0.01, 'Arch2 Co MILP LB')
plot(pod100CoAvg(1, 2), pod100CoAvg(2, 2)*0.01, 'd', 'displayname', 'Arch2 Co MILP UB', 'linewidth', 2)
text(pod100CoAvg(1, 2)+10, pod100CoAvg(2, 2)*0.01, 'Arch2 Co MILP UB')

plot(pod100ThAvg(1, 1), pod100ThAvg(2, 1)*0.01, 'v', 'displayname', 'Arch2 Th MILP LB', 'linewidth', 2)
text(pod100ThAvg(1, 1)+10, pod100ThAvg(2, 1)*0.01, 'Arch2 Th MILP LB')
plot(pod100ThAvg(1, 2), pod100ThAvg(2, 2)*0.01, '^', 'displayname', 'Arch2 Th MILP UB', 'linewidth', 2)
text(pod100ThAvg(1, 2)+10, pod100ThAvg(2, 2)*0.01, 'Arch2 Th MILP UB')

plot(pod100HyAvg(1, 1), pod100HyAvg(2, 1)*0.01, 'v', 'displayname', 'Arch2 Hy MILP LB', 'linewidth', 2)
text(pod100HyAvg(1, 1)+10, pod100HyAvg(2, 1)*0.01, 'Arch2 Hy MILP LB')
plot(pod100HyAvg(1, 2), pod100HyAvg(2, 2)*0.01, '^', 'displayname', 'Arch2 Hy MILP UB', 'linewidth', 2)
text(pod100HyAvg(1, 2)+10, pod100HyAvg(2, 2)*0.01, 'Arch2 Hy MILP UB')

plot(pod100SaAvg(1, 1), pod100SaAvg(2, 1)*0.01,  '<', 'displayname', 'Arch2 Hy SA', 'linewidth', 2)
text(pod100SaAvg(1, 1)+10, pod100SaAvg(2, 1)*0.01, 'Arch2 Hy SA')
plot(pod100SaAvg(1, 2), pod100SaAvg(2, 2)*0.01,  '<', 'displayname', 'Arch2 Co SA', 'linewidth', 2)
text(pod100SaAvg(1, 2)+10, pod100SaAvg(2, 2)*0.01, 'Arch2 Co SA')
plot(pod100SaAvg(1, 3), pod100SaAvg(2, 3)*0.01,  '<', 'displayname', 'Arch2 Th SA', 'linewidth', 2)
text(pod100SaAvg(1, 3)+10, pod100SaAvg(2, 3)*0.01, 'Arch2 Th SA')
