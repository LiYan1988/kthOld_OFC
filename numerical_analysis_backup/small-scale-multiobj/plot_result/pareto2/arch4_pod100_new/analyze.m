...
for i=0:19
    newFileName = sprintf('result_pareto_arch4_new_pod100_%d.csv',i);
...
h(3) = plot(resultAve(:,2)*0.87,resultAve(:,3)*0.001*0.87, '--', 'displayname', '87% of optimal', 'linewidth', 2);

paretoArch4New(:,1) = resultAve(:,2);
paretoArch4New(:,2) = resultAve(:,3)*0.001;
paretoArch4New(:,3) = resultAve(:,8);
paretoArch4New(:,4) = resultAve(:,9)*0.001;
