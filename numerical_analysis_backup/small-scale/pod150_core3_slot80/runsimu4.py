# -*- coding: utf-8 -*-
"""
Created on Sun Jun  5 09:38:40 2016
...
#    print filename
    ...
    m.create_model_routing(mipfocus=1,timelimit=100,mipgap=0.005)
    tmp = -m.model_routing.objVal
    result_arch4_ub.append(tmp)
    try:
        m.create_model_sa(mipfocus=1,timelimit=7200)
    ...
    m.create_model(mipfocus=1, timelimit=100,mipgap=0.001)
    ...
    m.create_model_routing(mipfocus=1,timelimit=100,mipgap=0.01)
    tmp = -m.model_routing.objVal
    result_arch2_ub.append(tmp)
    try:
        m.create_model_sa(mipfocus=1,timelimit=5400)
    ...
    m.create_model_routing(mipfocus=1, timelimit=100, mipgap=0.001)
    tmp = m.n_suc_routing
