...
for i in range(20):
    ...
    newline3 = "#SBATCH -J pareto_arch5_pod100_nf_"+str(i)+"\n"
    newline6 = "#SBATCH -o pareto_arch5_pod100_nf_"+str(i)+".stdout\n"
    newline7 = "#SBATCH -e pareto_arch5_pod100_nf_"+str(i)+".stderr\n"
