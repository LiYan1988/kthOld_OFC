# -*- coding: utf-8 -*-
"""
Created on Thu Sep  8 22:21:08 2016
...
#                quicksum(core_usage[u,u[1],k] for k in self.cores))
        ...
        self.connections_ub_ = len(suclist)
        self.throughput_ub_ = sum(self.tm[u[0],u[1]] for u in self.suclist_dc)
        self.obj_ub_ = self.alpha*self.connections_ub_+self.beta*self.throughput_ub_
...
#            
    ...
    def write_result_csv(self, file_name, suclist):
        with open(file_name, 'w') as f:
            f.write('src,dst,spec,core_src,core_dst,used_slot,tfk_slot\n')
            for u in suclist:
                wstr = '{},{},{},{},{},{},{}\n'.format(u[0], u[1], self.spec_idxx[u], 
                    self.core_usagex[u,u[0]], self.core_usagex[u,u[1]],
...
if __name__=='__main__':
    ...
    #%% test heuristic
    m.create_model_routing(mipfocus=1,timelimit=100,mipgap=0.01,method=3) # Method=2 or 3
