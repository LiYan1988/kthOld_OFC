...
% bar1 = bar(y);
% set(bar1(1),'DisplayName','Arch 1','FaceColor',[0 0.45 0.74]);
% set(bar1(2),'DisplayName','Arch 2','FaceColor',[0.85 0.33 0.01]);
% set(bar1(3),'DisplayName','Arch 3','FaceColor',[0.93 0.69 0.13]);
% 
% % Create xlabel
